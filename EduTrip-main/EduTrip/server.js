...
app.post('/api/register', async (req, res) => {
    ...
    if (!['BSCS', 'BSHM', 'BSTM', 'BAPOLSCIE', 'BSEED', 'BSBA'].includes(course)) {
...
app.get('/api/events', (req, res) => {
    ...
    const validCourses = ['BSCS', 'BSHM', 'BSTM', 'BAPOLSCIE', 'BSEED', 'BSBA', 'ALL'];
...
app.post('/api/events', upload.single('image'), (req, res) => {
    const { title, description, date, location, course } = req.body;
    ...
    db.query("INSERT INTO events (title, description, date, location, course, image_url) VALUES (?, ?, ?, ?, ?, ?)",
        [title, description, date, location, normalizedCourse, imageUrl], (err, result) => {
            if (err) {
