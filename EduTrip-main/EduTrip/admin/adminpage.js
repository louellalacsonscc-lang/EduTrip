...
function initializePage() {
    ...
    if (createEventForm) {
        createEventForm.addEventListener('submit', function (e) {
            ...
            eventData.append('title', document.getElementById('event-title').value);
            eventData.append('description', document.getElementById('event-description').value);
            eventData.append('date', document.getElementById('event-date').value);
            eventData.append('location', document.getElementById('event-location').value);
            eventData.append('course', document.getElementById('event-course').value);

            const eventImage = document.getElementById('event-image');
            if (eventImage?.files?.[0]) {
                eventData.append('image', eventImage.files[0]);
            }
